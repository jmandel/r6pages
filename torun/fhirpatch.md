...
- Page topic hints: `fhirpatch`
- Detailed research output path: `todo/research/fhirpatch.md` (batch convention: `todo/research/fhirpatch.md`)
- Actionable findings output path: `todo/actions/fhirpatch.md` (batch convention: `todo/actions/fhirpatch.md`)
...
1. A detailed research appendix in `todo/research/fhirpatch.md`.
2. A concise, high-signal actionable findings file in `todo/actions/fhirpatch.md`.
...
Confirm whether `source/fhirpatch.html` exists in both trees:
...
```bash
wc -l "fhir-spec-search/trees/source/hl7.fhir.core/6.0.0-ballot4-5d67a34a13a5/source/fhirpatch.html"
sed -n '1,220p' "fhir-spec-search/trees/source/hl7.fhir.core/6.0.0-ballot4-5d67a34a13a5/source/fhirpatch.html"
sed -n '221,440p' "fhir-spec-search/trees/source/hl7.fhir.core/6.0.0-ballot4-5d67a34a13a5/source/fhirpatch.html"
```
...
- cited commits actually change `source/fhirpatch.html`
...
Write `todo/research/fhirpatch.md`. This file may be detailed and is allowed to preserve evidence that is not directly actionable. Keep it organized for later audit, but do not try to make every contextual hit sound important.

Make this appendix a fast handoff for a future reviewer. Include direct links or precise locators for evidence:

- local source file paths and line ranges, such as `fhir-spec-search/trees/source/hl7.fhir.core/6.0.0-ballot4-5d67a34a13a5/source/fhirpatch.html:123`
...
Write `todo/actions/fhirpatch.md`. This file must be high signal and much shorter than the research appendix.
